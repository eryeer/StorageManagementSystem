				...
				<s:form action="store_edit" namespace="/" method="post" name="select">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tx" align="center">
						...
						<tr>
							...
							<td>
								<s:textfield name="addr" cssClass="tx"></s:textfield>
								<s:fielderror fieldName="addr"></s:fielderror>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<s:textfield name="manager" cssClass="tx"></s:textfield>
								<s:fielderror fieldName="manager"></s:fielderror>
							</td>
						</tr>
						<tr>
